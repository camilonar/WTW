...
public class ProgramaAgendaAdapter extends RecyclerView.Adapter<ProgramaAgendaAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView mTextView, txtHora, txtCanal;
        ...
        public ViewHolder(View v) {
            ...
            txtHora = (TextView)v.findViewById(R.id.textHora);
            txtCanal = (TextView)v.findViewById(R.id.textCanal);
            mTextView.setTypeface(RobotoFont.getInstance(v.getContext()).getTypeFace());
            txtHora.setTypeface(RobotoFont.getInstance(v.getContext()).getTypeFace());
            txtCanal.setTypeface(RobotoFont.getInstance(v.getContext()).getTypeFace());
    ...
    public ProgramaAgendaAdapter(Programa[] myDataset) {
        mDataset = myDataset;
        parent="";
    }
    ...
    @Override
    public ProgramaAgendaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tv_programa_agenda, parent, false);
        v.setClickable(true);
